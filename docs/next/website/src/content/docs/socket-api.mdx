...
assignments, and passwords or credential query parameters in URLs. The program
name and argument layout are kept, so callers can still tell what is running.
