...
## Text beside a wide character disappears after resizing

After narrowing and widening a pane, newly printed text beside a clipped CJK character or emoji should remain visible. Writing into the wide character's former second column clears the old character, just like overwriting the second half of an intact wide character. Widening the pane without overwriting still restores the clipped character. If replacement text disappears on an older build, update Herdr and restart the affected server.
